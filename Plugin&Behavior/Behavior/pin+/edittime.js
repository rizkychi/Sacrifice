...
AddComboParamOption("Enabled 3 (scale the pin coordinate)");
...
AddComboParamOption("Enabled");
AddComboParam("State", "Choose if Disabled or Enabled.");
AddAction(19, af_none, "pinDestroy", "", "Pin Destroy", "Pin the Destroy", "pinDestroy");
...
AddExpression(1, ef_return_number, "", "", "isPinnedX", "returns 0, 1, or 2,3 (disabled or enabled)");
AddExpression(2, ef_return_number, "", "", "isPinnedY", "returns 0, 1, or 2,3 (disabled or enabled)");
...
AddExpression(18, ef_return_number, "", "", "isPinnedDestroy", "returns 0 or 1 (disabled or enabled)");
...
var property_list = [
		new cr.Property(ept_combo,		"X",	"Disabled",		"Copy x position of pinned object.", "Disabled|Enabled|Enabled 2 (disregard distance when pinned)|Enabled 3 (scale the pin coordinate)"),
		new cr.Property(ept_combo,		"Y",	"Disabled",		"Copy y position of pinned object.", "Disabled|Enabled|Enabled 2 (disregard distance when pinned)|Enabled 3 (scale the pin coordinate)"),
		...
		//new cr.Property(ept_combo,		"Mirror Angle",	"Disabled",		"Copy mirrored angle of pinned object.", "Disabled|Enabled"),
		//new cr.Property(ept_combo,		"Flip Angle",	"Disabled",		"Copy flipped angle of pinned object.", "Disabled|Enabled"),
		new cr.Property(ept_combo,		"Destroy",	"Disabled",		"Copy destroy of pinned object.", "Disabled|Enabled")
	];
